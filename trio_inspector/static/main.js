...
var author$project$Main$Nursery = F3(
	function (id, name, tasks) {
		return {id: id, name: name, tasks: tasks};
	});
var author$project$Main$Task = F3(
	function (id, name, nurseries) {
		return {id: id, name: name, nurseries: nurseries};
	});
var author$project$Main$Tasks = function (a) {
	return {$: 'Tasks', a: a};
};
...
function author$project$Main$cyclic$nurseryDecoder() {
	return A4(
		...
		author$project$Main$Nursery,
		A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$int),
		A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
		A2(
			elm$json$Json$Decode$field,
			'tasks',
			author$project$Main$cyclic$tasksDecoder()));
}
function author$project$Main$cyclic$taskDecoder() {
	return A4(
		elm$json$Json$Decode$map3,
		...
		A2(
			...
			elm$json$Json$Decode$list(
				elm$json$Json$Decode$lazy(
					function (_n1) {
						return author$project$Main$cyclic$nurseryDecoder();
					}))));
}
function author$project$Main$cyclic$tasksDecoder() {
	return A2(
		elm$json$Json$Decode$map,
		author$project$Main$Tasks,
		elm$json$Json$Decode$list(
			elm$json$Json$Decode$lazy(
				function (_n0) {
					return author$project$Main$cyclic$taskDecoder();
				})));
}
try {
	var author$project$Main$nurseryDecoder = author$project$Main$cyclic$nurseryDecoder();
	author$project$Main$cyclic$nurseryDecoder = function () {
		return author$project$Main$nurseryDecoder;
	};
	var author$project$Main$taskDecoder = author$project$Main$cyclic$taskDecoder();
	author$project$Main$cyclic$taskDecoder = function () {
		return author$project$Main$taskDecoder;
	};
	var author$project$Main$tasksDecoder = author$project$Main$cyclic$tasksDecoder();
	author$project$Main$cyclic$tasksDecoder = function () {
		return author$project$Main$tasksDecoder;
	};
} catch ($) {
...
var author$project$Main$loadTasks = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Main$GotTasks, author$project$Main$taskDecoder),
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'GotTasks':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var rootTask = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								rootTask: elm$core$Maybe$Just(rootTask)
							}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{rootTask: elm$core$Maybe$Nothing}),
						elm$core$Platform$Cmd$none);
				}
			case 'GotStats':
				var result = msg.a;
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								stacktrace: elm$core$Maybe$Just(stacktrace)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
...
var author$project$Main$navBar = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('nav nav-tabs bg-primary')
		]),
	_List_fromArray(
		[
			A2(
...
var author$project$Main$viewStacktrace = function (stacktrace) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(
			elm$core$List$map,
			function (frame) {
				var basename = elm$core$List$head(
					elm$core$List$reverse(
						A2(elm$core$String$split, '/', frame.filename)));
				var basenameWithLineNo = function () {
					if (basename.$ === 'Nothing') {
						return '-';
					} else {
						var name = basename.a;
						return name + (':' + elm$core$String$fromInt(frame.lineno));
					}
				}();
				return A2(
					elm$html$Html$div,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('list-group-item flex-column align-items-start')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('d-flex w-100 justify-content-between')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											elm$html$Html$text(basenameWithLineNo)
										]))
								])),
							A2(
							elm$html$Html$p,
							...
							_List_fromArray(
								[
									elm$html$Html$text(frame.filename)
								]))
						]));
			},
			stacktrace));
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Number of tasks')
											])),
										A2(
										elm$html$Html$td,
										_List_fromArray(
										...
										_List_fromArray(
											[
												elm$html$Html$text(
												elm$core$String$fromInt(stats.tasksLiving))
											]))
									])),
								A2(
								elm$html$Html$tr,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Number of queued tasks')
											])),
										A2(
										elm$html$Html$td,
										_List_fromArray(
										...
										_List_fromArray(
											[
												elm$html$Html$text(
												elm$core$String$fromInt(stats.tasksRunnable))
											]))
									])),
								A2(
								elm$html$Html$tr,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text(stats.ioStatisticsBackend)
											]))
									]))
							]))
					]))
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('tasktree col-sm-6')
									]),
								_List_fromArray(
									[
										function () {
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('stats col-sm-6')
									]),
								_List_fromArray(
									[
										function () {
